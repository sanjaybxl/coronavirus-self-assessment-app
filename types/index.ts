...
export type QuestionTranslations = typeof import("../public/locales/en/questions.json");
...
export type AssessmentTranslations = typeof import("../public/locales/en/assessment.json");
export type AssessmentTranslationKey = keyof AssessmentTranslations;

export type Assessment = {
    title: AssessmentTranslationKey;
    lead?: AssessmentTranslationKey;
    illnessScore: number;
    riskScore: number;
